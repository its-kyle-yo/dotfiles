# Generated by Powerlevel10k configuration wizard on 2020-10-12 at 10:50 CDT.
...
# round separators, sharp heads, round tails, 2 lines, dotted, left frame, sparse,
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=214
